"""create practices tables

Revision ID: 14c98f8abfea
Revises: 86a3daf9e0da
Create Date: 2025-01-16 01:37:23.453206
...
revision: str = "14c98f8abfea"
down_revision: Union[str, None] = "86a3daf9e0da"
...
def upgrade() -> None:
    ...
    # Create practice_user_roles table
    op.create_table(
        "practice_user_roles",
        sa.Column("id", sa.BigInteger(), primary_key=True),
        sa.Column(
    ...
    op.create_unique_constraint(
        "uq_practice_user_roles_user_practice",
        "practice_user_roles",
        ["user_id", "practice_id"],
    )
